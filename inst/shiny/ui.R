                             ...
                             tabsetPanel(id="tabs3", type="pills",
                                tabPanel("New",
                                   ...
                                   column(width=3,
                                         ...
                                         radioButtons("filters", label = h4("Approaches", bsButton("infofilters", label="", icon=icon("info"), style="info", size="extra-small")), choices=c("Raw Gene-sets"="none","Unique Gene-sets"="uniquepathways"), selected = character(0), inline=TRUE),
                                         bsPopover(id="infofilters", title="Approaches", content="Raw Gene-sets: include all gene-sets independently. Unique Gene-sets: combine gene-sets with same label.", placement = "right", trigger="hover"),
                                ...
                                tabPanel("Upload",
                                    ...
                                    column(width=3,
                                        ...
                                        radioButtons("uploadfilters", label = h4("Approaches", bsButton("infouploadfilters", label="", icon=icon("info"), style="info", size="extra-small")), choices=c("Raw Gene-sets"="none","Unique Gene-sets"="uniquepathways"), selected = character(0), inline=TRUE),
                                        bsPopover(id="infouploadfilters", title="Approaches", content="Raw Gene-sets: include all gene-sets independently. Unique Gene-sets: combine gene-sets with same label.", placement = "right", trigger="hover"),
                                     ...
                                     fluidRow(
                                       ...
                                       column(2,
                                          div(style = "display: flex; flex-direction: column; align-items: flex-start;",
                                              ...
                                              div(style = "margin-bottom: 10px;", uiOutput("downloadData")), 
                                              
                                              # Second row containing two buttons side by side
                                              div(style = "display: flex; gap: 10px;",
                                                  div(uiOutput("downloadDataFormats"), style = "flex: 1;"),
                                                  div(uiOutput("saveObject"), style = "flex: 1;")
                                              )
                                          ),
                                          br(),
                                          br(),
